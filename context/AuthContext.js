...
export const AuthContextProvider = ({children}) =>{
    ...
    return <AuthContext.Provider value = {{ user, logIn, signUp, signInGoogle, logout, provider, forgotPassword, resetPassword }}>{ loading ? null : children}</AuthContext.Provider>
}