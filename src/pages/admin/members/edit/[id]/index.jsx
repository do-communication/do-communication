...
//     data.Name = mem._document.data.value.mapValue.fields.Name.stringValue
//     data.Email = mem._document.data.value.mapValue.fields.Email.stringValue
//     data.Address = mem._document.data.value.mapValue.fields.Address.stringValue
//     data.Gender = mem._document.data.value.mapValue.fields.Gender.stringValue
//     data.PhoneNumber = mem._document.data.value.mapValue.fields.PhoneNumber.stringValue
//     data.Department = mem._document.data.value.mapValue.fields.Department.stringValue
//     data.DateOfBirth = mem._document.data.value.mapValue.fields.DateOfBirth.stringValue
//     data.ProfilePic = mem._document.data.value.mapValue.fields.ProfilePic.stringValue
//     data.RegisteredAt = mem._document.data.value.mapValue.fields.RegisteredAt.stringValue
...
//       });}
//     data.GroupId = tempGroup
//     data.Reports = tempReport
//     data.Tasks = tempTask
...
//     // // // address.placeholder = "";
//     // if(pho){pho.value = data.PhoneNumber;}
//     // // // pho.placeholder = "+251 9";
//     // if(date){date.value = data.DateOfBirth;}
//     // // // date.placeholder = "MM/DD/YYYY";
//     // if(dep){dep.value = data.Department;}
...
//   // const handleName = (e) => {
//     // e.preventDefault();
//     name && name.addEventListener('change', function handleChange(e){
